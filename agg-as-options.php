...
<nav class="nav-tab-wrapper">
  <a href="?page=aggregator-options&tab=general" class="nav-tab <?php if($tab==='general'): ?>nav-tab-active<?php endif; ?>"><span style="font-size: 16px"><i class="fas fa-cog"></i></span> <?php _e("General Options", 'agg-advanced-settings' ); ?></a>
  <a href="?page=aggregator-options&tab=login" class="nav-tab <?php if($tab==='login'):?>nav-tab-active<?php endif; ?>"><span style="font-size: 16px"><i class="fas fa-sign-in-alt"></i></span> <?php _e("Login Options", 'agg-advanced-settings' ); ?></a>
</nav>
...
<tr>
<th scope="row"><i class="fas fa-code" style="color:<?php echo $opt[++$i]['value'] == 1 ? '#000000' : '#808080' ; ?>;"></i>
...
<tr>
<th scope="row"><i class="fas fa-user" style="color:<?php echo $opt[++$i]['value'] == 1 ? '#000000' : '#808080' ; ?>;"></i>
...
<tr>
<th scope="row"><i class="fas fa-key" style="color:<?php echo $opt[++$i]['value'] == 1 ? '#000000' : '#808080' ; ?>;"></i>
